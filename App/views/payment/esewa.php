    ...
    <div class="max-w-3xl mx-auto bg-white cardclip shadow-md p-8">
        <div class="flex flex-col items-center mb-8">
            <div class="rounded-full bg-primary/10 p-3 mb-4">
                <img src="<?= ASSETS_URL ?>/images/gateways/esewa.svg" alt="eSewa" class="w-16 h-16" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
        ...
        <div class="flex justify-center">
            <button id="payment-button" class="btn-primary px-8 py-3 text-white shadow-lg text-sm font-medium flex items-center justify-center">
                ...
                <img src="<?= ASSETS_URL ?>/images/gateways/esewa.svg" alt="eSewa" class="h-6 w-auto" onerror="this.style.display='none';">
            </button>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function showError(message) {
        ...
        paymentButton.innerHTML = '<span class="mr-2">Pay with eSewa</span><img src="<?= ASSETS_URL ?>/images/gateways/esewa.svg" alt="eSewa" class="h-6 w-auto">';
    }
    ...
    function initiatePayment() {
        ...
        fetch('<?= ASSETS_URL ?>/payment/initiateEsewa/<?= $order['id'] ?>', {
            method: 'POST',
            headers: {
