...
<div class="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        <div class="text-center">
            ...
            <!-- Error Code -->
            <h1 class="text-6xl font-bold text-gray-900 mb-4"><?= $error_code ?? 500 ?></h1>
            
            <!-- Error Message -->
            <h2 class="text-2xl font-semibold text-gray-700 mb-4"><?= $error_message ?? 'Internal Server Error' ?></h2>
    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                    ...
                    <ul class="space-y-2">
                        <?php foreach ($suggestions as $suggestion): ?>
                            <li class="flex items-center text-sm text-gray-600">
                                <svg class="flex-shrink-0 h-4 w-4 text-orange-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div class="space-y-3">
                ...
                <a href="<?= \App\Core\View::url('home/contact') ?>" 
                   class="w-full flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-colors">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
