    ...
    <div class="p-3 sm:p-4">
        <div class="grid grid-cols-4 gap-4 sm:gap-6">
            ...
            <a href="<?= \App\Core\View::url('sellers') ?>" 
               ...
               title="Stores">
                <div class="w-12 h-12 sm:w-16 sm:h-16 bg-gray-50 rounded-2xl flex items-center justify-center border border-gray-200 overflow-hidden">
                    <img src="<?= \App\Core\View::publicAsset('images/screen/store.png') ?>" alt="Stores" class="w-full h-full object-contain p-2">
                </div>
            ...
            <a href="<?= \App\Core\View::url('coupons') ?>" 
               ...
               title="Coupons">
                <div class="w-12 h-12 sm:w-16 sm:h-16 bg-gray-50 rounded-2xl flex items-center justify-center border border-gray-200 overflow-hidden">
                    <img src="<?= \App\Core\View::publicAsset('images/screen/coupon.svg') ?>" alt="Coupon" class="w-full h-full object-contain p-2">
                </div>
            ...
            <a href="<?= \App\Core\View::url('affiliate/products') ?>" 
               ...
               title="Affiliate Program">
                <div class="w-12 h-12 sm:w-16 sm:h-16 bg-gray-50 rounded-2xl flex items-center justify-center border border-gray-200 overflow-hidden">
                    <img src="<?= \App\Core\View::publicAsset('images/screen/affilate.svg') ?>" alt="Affiliate" class="w-full h-full object-contain p-2">
                </div>
            ...
            <a href="<?= \App\Core\View::url('products?sort=popular') ?>" 
               ...
               title="Top Selling Products">
                <div class="w-12 h-12 sm:w-16 sm:h-16 bg-gray-50 rounded-2xl flex items-center justify-center border border-gray-200 overflow-hidden">
                    <img src="<?= \App\Core\View::publicAsset('images/screen/topsale.svg') ?>" alt="Top Sale" class="w-full h-full object-contain p-2">
                </div>
            ...
            <a href="<?= \App\Core\View::url('products') ?>" 
               ...
               title="All Categories">
                <div class="w-12 h-12 sm:w-16 sm:h-16 bg-gray-50 rounded-2xl flex items-center justify-center border border-gray-200 overflow-hidden">
                    <img src="<?= \App\Core\View::publicAsset('images/screen/cateogory.svg') ?>" alt="Categories" class="w-full h-full object-contain p-2">
                </div>
