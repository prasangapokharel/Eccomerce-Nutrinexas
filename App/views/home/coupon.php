        ...
        <div class="mb-8 max-w-2xl mx-auto">
            <div class="relative">
                <input
                    ...
                    class="input native-input w-full pl-12"
                >
                <svg class="w-4 h-4 text-neutral-500 absolute left-4 top-1/2 -translate-y-1/2 transform pointer-events-none" fill="none" stroke="currentColor" viewBox="0 0 24 24">
