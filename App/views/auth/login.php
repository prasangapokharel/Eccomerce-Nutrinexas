        ...
        <div class="login-form bg-white rounded-2xl shadow-xl p-8">
            ...
            <div class="mt-4">
                <a href="<?= \App\Core\View::url('auth/google') ?>" 
                   class="w-full flex items-center justify-center px-6 py-4 bg-white border-2 border-gray-300 text-gray-700 font-semibold rounded-xl shadow-sm hover:bg-gray-50 hover:border-gray-400 transition-all">
