...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">Apply a discount percentage to all active products</p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <form method="POST" action="<?= \App\Core\View::url('admin/sales/create') ?>" class="space-y-6">
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-blue-700">
                            <strong>Note:</strong> This sale will automatically apply the discount percentage to all active products. 
                            The sale price will be calculated as: Original Price - (Original Price × Discount %)
                        </p>
                    </div>
                </div>
            </div>
