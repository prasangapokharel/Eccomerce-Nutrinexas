...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h1 class="text-2xl lg:text-3xl font-bold text-gray-900">Cancelled & Returned Items Report</h1>
            <p class="mt-1 text-sm text-gray-500">Track cancelled and returned orders for your products</p>
        </div>
    </div>
        ...
        <div class="p-6 border-b border-gray-100">
            ...
            <form method="GET" class="flex flex-col sm:flex-row gap-4">
                <div class="flex-1">
                    ...
                    <select id="period" name="period" onchange="this.form.submit()" class="input native-input">
                ...
                <div class="flex-1">
                    ...
                    <select id="type" name="type" onchange="this.form.submit()" class="input native-input">
