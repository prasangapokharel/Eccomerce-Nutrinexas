...
class PaymentController extends Controller
{
    ...
    public function initiateEsewa($orderId)
    {
        ...
        try {
            ...
            // Use same calculation logic as CheckoutController
            ...
            // Prepare eSewa payment data (new format like CheckoutController)
            $paymentData = [
                ...
                'success_url' => ASSETS_URL . '/payment/esewa/success/' . $orderId,
                'failure_url' => ASSETS_URL . '/payment/esewa/failure/' . $orderId,
                'signed_field_names' => 'total_amount,transaction_uuid,product_code'
            ];
            
            // Generate signature using HMAC SHA256 (same as CheckoutController)
            ...
            // Get payment URL from configuration (same as CheckoutController)
