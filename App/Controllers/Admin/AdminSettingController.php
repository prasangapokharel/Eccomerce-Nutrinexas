...
class AdminSettingController extends Controller
{
    ...
    {
        // Validate minimum withdrawal amount if provided
        if (isset($data['min_withdrawal'])) {
        ...
        // Validate remember token days if provided
        if (isset($data['remember_token_days'])) {
        ...
        // Maintenance mode is boolean, no validation needed
        // Auto approve is boolean, no validation needed
        // Enable remember me is boolean, no validation needed
